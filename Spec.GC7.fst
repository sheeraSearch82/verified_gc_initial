...
(
  ...
  sum_of_multiple_of_mword_is_multiple_of_mword h_index (Usize.mul wz mword);                                                                             // h_index_new = 0 + 
                                                                               // first field range in g = 8......15. Only one field. So next header starts at 16
  if Usize.v h_index_new <= heap_size then //valid heap condition
  (
    if Usize.v h_index_new = heap_size then // h_index_new == heap_size --> The last block is h_index, So just create a singleton with h_index and return.
...
let rec is_fields_contents_within_limit2_lemma1(h_index: hp_addr) 
                           ...
                           : Lemma
                            (requires (wz == wz') /\
                                      ...
                                      (Usize.v (read_word g p) >= 0 /\
                                       Usize.v (read_word g p) < heap_size)*)
                                       (isPointer p g ==> (Usize.v (read_word g p) >= 0 /\ Usize.v (read_word g p) < heap_size)) /\
                                       (isPointer p g' ==> (Usize.v (read_word g' p) >= 0 /\ Usize.v (read_word g' p) < heap_size)))
...
let rec check_all_block_fields_within_limit2_lemma1 (g:heap)
                                                    (g':heap)
                                                    ...
                                                    (k:hp_addr{(*(Usize.v k >= Usize.v x + Usize.v mword /\
                                                         Usize.v k <= Usize.v x + (Usize.v (getWosize (read_word g x)) * Usize.v mword))*)
                                                                Usize.v k == Usize.v x + Usize.v mword})
                                : Lemma
                                  (requires (f' == f'')  /\
                                            (objects2 0UL g ==
                                             objects2 0UL g') /\
                                            ...
                                            (forall p (y:hp_addr). Seq.mem p (objects2 0UL g)(*f'*) /\  p <> x /\ Usize.v y >= Usize.v p + Usize.v mword /\
                                            ...
                                            (forall (i:Usize.t {Usize.v i > 0 /\ Usize.v i <= Usize.v (getWosize (read_word g x))}). k <> (Usize.add x (Usize.mul i mword)) ==>
   ...
   | _ -> assert (length f' > 0);
        ...
        if (hd <> x) then
         (
            ...
            if (is_fields_contents_within_limit2 hd wz g) then
             (  
               check_all_block_fields_within_limit2_lemma1 g g' tl tl' x k;
               ()
            )
            else
            ()
         ...
         (
           assert (hd == x);
           is_fields_contents_within_limit2_lemma1 hd wz wz' g g' k;
           if (is_fields_contents_within_limit2 hd wz g) then
             (  
               check_all_block_fields_within_limit2_lemma1 g g' tl tl' x k;
               ()
...
let rec is_fields_contents_within_limit2_lemma9(h_index: hp_addr) 
                                               (wz: wosize{is_fields_within_limit1 h_index wz})
                                               (wz': wosize{is_fields_within_limit1 h_index wz'})
                                               (g:heap) 
                                               (g':heap) 
                                               (p:hp_addr{Usize.v p == Usize.v h_index + Usize.v mword}(*{(Usize.v p >= Usize.v h_index + Usize.v mword /\
                                                         Usize.v p <= Usize.v h_index + (Usize.v (getWosize (read_word g h_index)) * Usize.v mword))}*))
                                          
                           : Lemma
                            (requires (wz == wz') /\
                                      (forall (i:Usize.t {Usize.v i > 1 /\ Usize.v i <= Usize.v wz}). (*p <> (Usize.add h_index (Usize.mul i mword)) ==>*)
                                                     Usize.v (read_word g (Usize.add h_index (Usize.mul i mword))) == 
                                                     Usize.v (read_word g' (Usize.add h_index (Usize.mul i mword)))) /\
                                      (*(Usize.v (read_word g' p) >= 0 /\
                                       Usize.v (read_word g' p) < heap_size) /\
...
if (Usize.v wz = 0) then ()
 ...
 (
   ...
   (
     ...
     if Usize.v succ >= 0 && Usize.v succ < heap_size then
          (
            let _ = is_fields_contents_within_limit2_lemma9 h_index wz1 wz2 g g' p in
            ()
         )
     else
         ()
   ...
   (
      assert (~(isPointer s g));
      is_fields_contents_within_limit2_lemma9 h_index wz1 wz2 g g' p;
      assert (is_fields_contents_within_limit2 h_index wz1 g == true <==>
              is_fields_contents_within_limit2 h_index wz2 g' == true);
      assert (is_fields_contents_within_limit2 h_index wz g == true <==>
              is_fields_contents_within_limit2 h_index wz' g' == true);
...
let rec check_all_block_fields_within_limit2_lemma9 (g:heap)
                                                    (g':heap)
                                                    (f':seq Usize.t {(forall x. Seq.mem x f' ==> Usize.v x >= 0 /\ Usize.v x < heap_size) /\
                                                                 (forall x. Seq.mem x f' ==> Usize.v x % Usize.v mword == 0) /\
                                                                 (forall x. Seq.mem x f' ==> Seq.mem x (objects2 0UL g))})
                                ...
                                : Lemma
                                  (requires (f' == f'')  /\
                                            ...
                                            (forall (i:Usize.t {Usize.v i > 1 (*0*) /\ Usize.v i <= Usize.v (getWosize (read_word g x))}). (*k <> (Usize.add x (Usize.mul i mword)) ==>*)
                                                     Usize.v (read_word g (Usize.add x (Usize.mul i mword))) == 
                                                     Usize.v (read_word g' (Usize.add x (Usize.mul i mword)))) /\
                                             (*(Usize.v (read_word g' k) >= 0 /\
                                               Usize.v (read_word g' k) < heap_size) /\
   ...
   | _ -> assert (length f' > 0);
        ...
        if (hd <> x) then
         (
            ...
            if (is_fields_contents_within_limit2 hd wz g) then
             (  
               check_all_block_fields_within_limit2_lemma9 g g' tl tl' x k;
               ()
            )
            else
            ()
         ...
         (
           assert (hd == x);
           is_fields_contents_within_limit2_lemma9 hd wz wz' g g' k;
           if (is_fields_contents_within_limit2 hd wz g) then
             (  
               check_all_block_fields_within_limit2_lemma9 g g' tl tl' x k;
               ()
...
(*let rec check_all_block_fields_within_limit2_lemma3 g g' f' f'' x k = 
match length f' with
   | 0 -> ()
   | _ -> assert (length f' > 0);
         let hd = Seq.head f' in
        ...
        if (hd <> x) then
         (
            ...
            if (is_fields_contents_within_limit2 hd wz g) then
             (  
               check_all_block_fields_within_limit2_lemma3 g g' tl tl' x k;
               ()
            )
            else
            ()
...
let rec check_all_block_fields_within_limit2_lemma5 (g:heap)
                                                    (g':heap)
                                                    (f':seq Usize.t {(forall x. Seq.mem x f' ==> Usize.v x >= 0 /\ Usize.v x < heap_size) /\
                                                                 (forall x. Seq.mem x f' ==> Usize.v x % Usize.v mword == 0) /\
                                                                 (forall x. Seq.mem x f' ==> Seq.mem x (objects2 0UL g))})
                                ...
                                : Lemma
                                  (requires (f' == f'')  /\
                                            ...
                                            (forall p. Seq.mem p (objects2 0UL g) ==> is_fields_within_limit1 p  (getWosize (read_word g p))) /\
                                            (forall p. Seq.mem p (objects2 0UL g) ==> 
                                                      (forall (i:Usize.t {Usize.v i > 0 /\ Usize.v i <= Usize.v (getWosize (read_word g p))}). 
                                                            is_hp_addr (Usize.add p (Usize.mul i mword)))) /\
                                            (forall p. Seq.mem p (objects2 0UL g) /\ p <> x ==> 
                                                   (forall (j:hp_addr). Usize.v j >= Usize.v p + Usize.v mword /\
                                                       Usize.v j <= Usize.v p + (Usize.v (getWosize (read_word g p)) * Usize.v mword) ==> read_word g' j == read_word g j)) /\
   ...
   | _ -> assert (length f' > 0);
        ...
        if (hd <> x) then
         (
            ...
            if (is_fields_contents_within_limit2 hd wz g) then
             (  
               check_all_block_fields_within_limit2_lemma5 g g' tl tl' x k;
               ()
            )
            else
            ()
         ...
         (
           assert (hd == x);
           is_fields_contents_within_limit2_lemma3 hd wz wz' g g' k;
           if (is_fields_contents_within_limit2 hd wz g) then
             (  
               check_all_block_fields_within_limit2_lemma5 g g' tl tl' x k;
               ()
 ...
 if (Usize.v wz = 0) then true
  ...
  (
    ...
    //Get the header of succ. succ_hdr = succ - mword
      if (Seq.mem succ (objects2 0UL g)) then
       (
...
let rec  is_fields_points_to_blocks3 (h_index: hp_addr) 
                                     (g:heap)
                                     (wz: wosize{(is_fields_within_limit1 h_index wz /\
                                               is_fields_contents_within_limit2 h_index wz g)}) 
                                     (f':seq Usize.t { (forall x. Seq.mem x f' ==> is_hp_addr x) /\
 ...
 if (Usize.v wz = 0) then true
  ...
  (
    ...
    //Get the header of succ. succ_hdr = succ - mword
      if (Seq.mem succ (objects2 0UL g)) then
       (
         ...
         is_fields_points_to_blocks3 h_index g wz' f'
       )
     //header is not part, so invalid pointer stored at the index s.
       else
       (
    ...
    (
      assert (~(isPointer s g));
      let b = is_fields_points_to_blocks3 h_index g wz' f' in
...
let rec is_fields_points_to_blocks2_lemma3  (h_index: hp_addr)
                                            (g:heap)
                                            (wz: wosize{(is_fields_within_limit1 h_index wz /\
                                                     is_fields_contents_within_limit2 h_index wz g)})
                                            (f':seq Usize.t { (forall x. Seq.mem x f' ==> Usize.v x >= 0 /\ Usize.v x < heap_size) /\
                                 ...
                                 : Lemma
                                  ...
                                  (ensures is_fields_points_to_blocks3 h_index g wz f' == true <==>
                                            is_fields_points_to_blocks3 h_index g' wz1 f'' == true)
                                  (decreases (Usize.v wz))  = 
assert (is_hp_addr h_index);
 if (Usize.v wz = 0) then ()
  else
  (
    ...
    //Get the header of succ. succ_hdr = succ - mword
      if (Seq.mem succ (objects2 0UL g)) then
       (
         assert (Seq.mem succ (objects2 0UL g));
         is_fields_points_to_blocks2_lemma3 h_index g wz' f' g' wz2 f'';
...
let rec is_fields_points_to_blocks2_lemma1 (h_index: hp_addr)
                                 ...
                                 : Lemma
                                  (requires (wz == wz1) /\
                                            (f' == f'')  /\
                                            ((objects2 0UL g') == (objects2 0UL g)) /\
                                      (forall (j:hp_addr). Usize.v j  > Usize.v h_index + Usize.v mword /\
                                            Usize.v j <= Usize.v h_index + (Usize.v wz * Usize.v mword) ==> read_word g j == read_word g' j) /\
                                      (isPointer p g  ==> Seq.mem (read_word g p) (objects2 0UL g)) /\
                                      (isPointer p g' ==> Seq.mem (read_word g' p) (objects2 0UL g')))
    ...
    (
      ...
      (
        ...
        (
            ...
            is_fields_points_to_blocks2_lemma1 h_index g wz' f' g' wz2 f'' p;
            ()
         )
...
let rec check_fields_points_to_blocks3 (g:heap)
                                       (f':seq Usize.t { (forall x. Seq.mem x f' ==> Usize.v x >= 0 /\ Usize.v x < heap_size) /\
                                                     (forall x. Seq.mem x f' ==> is_hp_addr x) /\
                                                     (forall x. Seq.mem x f' ==> Seq.mem x (objects2 0UL g)) /\
                              ...
                              : Tot (b:bool{b == true <==> (forall x. Seq.mem x f' ==>
                                          is_fields_points_to_blocks3 x g (getWosize (read_word g x)) (objects2 0UL g))})
                               (decreases length f')  =
 match length f' with
   | 0 -> true
   | _ -> assert (length f' > 0);
         ...
         let wz = getWosize (read_word g hd) in
         if Usize.v wz = 0 then
             check_fields_points_to_blocks3 g tl 
            
         else
           (
             assert (Usize.v wz > 0);
             assert (is_fields_contents_within_limit2 hd (getWosize (read_word g hd)) g);
             if (is_fields_points_to_blocks3 hd g (getWosize (read_word g hd)) (objects2 0UL g)) then
             (
                  check_fields_points_to_blocks3 g tl
             )
             else
...
let rec check_fields_points_to_blocks2_lemma3 (g:heap)
                                              (g':heap)
                                              (f':seq Usize.t {(forall x. Seq.mem x f' ==> Usize.v x >= 0 /\ Usize.v x < heap_size) /\
                                                           (forall x. Seq.mem x f' ==> is_hp_addr x) /\
                                                           (forall x. Seq.mem x f' ==> Seq.mem x (objects2 0UL g)) /\
                                        ...
                                        :  Lemma
                                           ...
                                           (ensures check_fields_points_to_blocks3 g f' == true <==> check_fields_points_to_blocks3 g' f'' == true)
                                           (decreases length f') = 
match length f' with
   | 0 -> ()
   | _ -> assert (length f' > 0);
         ...
         assert (Seq.mem hd f');
         if Usize.v wz = 0 then
           check_fields_points_to_blocks2_lemma3 g g' tl tl'
         else
          (
            assert (Usize.v wz > 0);
            assert (is_fields_contents_within_limit2 hd (getWosize (read_word g hd)) g);
            is_fields_points_to_blocks2_lemma3 hd g wz (objects2 0UL g) g' wz1 (objects2 0UL g');
            assert (is_fields_points_to_blocks3 hd g wz (objects2 0UL g) == true <==>
                                            is_fields_points_to_blocks3 hd g' wz1 (objects2 0UL g') == true);
            if (is_fields_points_to_blocks3 hd g wz (objects2 0UL g)) then
             (
              assert (is_fields_points_to_blocks3 hd g wz (objects2 0UL g));
              assert (is_fields_points_to_blocks3 hd g' wz1 (objects2 0UL g'));
              let _ = check_fields_points_to_blocks2_lemma3 g g' tl tl' in
              assert(check_fields_points_to_blocks3 g tl == true <==> check_fields_points_to_blocks3 g' tl' == true);
              
              assert (check_fields_points_to_blocks3 g f' == true <==> check_fields_points_to_blocks3 g' f'' == true);
              ()
             )
            else
             (
               assert (~(is_fields_points_to_blocks3 hd g (getWosize (read_word g hd)) (objects2 0UL g)));
               assert (check_fields_points_to_blocks3 g f' == true <==> check_fields_points_to_blocks3 g' f'' == true);
               ()
...
(*let rec check_fields_points_to_blocks2_lemma1 g g' f' f'' x k = 
match length f' with
   | 0 -> ()
   | _ -> assert (length f' > 0);
         let hd = Seq.head f' in
         ...
         if hd <> x then 
         (
           assert (forall (j:hp_addr). Usize.v j >= Usize.v hd + Usize.v mword /\
                                  Usize.v j <= Usize.v hd + (Usize.v (getWosize (read_word g hd)) * Usize.v mword) ==> 
           ...
           assert (is_fields_points_to_blocks2 hd g wz (objects2 0UL g) == true <==>
            ...
            if (is_fields_points_to_blocks2 hd g wz (objects2 0UL g)) then
             (
               assert (is_fields_points_to_blocks2 hd g wz (objects2 0UL g));
               assert (is_fields_points_to_blocks2 hd g' wz1 (objects2 0UL g'));
               let _ = check_fields_points_to_blocks2_lemma1 g g' tl tl' x k in
               assert(check_fields_points_to_blocks2 g tl == true <==> check_fields_points_to_blocks2 g' tl' == true);
         ...
         (
           assert (hd == x);
           is_fields_points_to_blocks2_lemma1 hd g wz (objects2 0UL g) g' wz1 (objects2 0UL g') k;
           if (is_fields_points_to_blocks2 hd g wz (objects2 0UL g)) then
             (
               assert (is_fields_points_to_blocks2 hd g wz (objects2 0UL g));
               assert (is_fields_points_to_blocks2 hd g' wz1 (objects2 0UL g'));
